...
public class TinyDB {
    ...
    public ArrayList<PopularItemModel> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<PopularItemModel> playerList = new ArrayList<PopularItemModel>();

        for (String jObjString : objStrings) {
            PopularItemModel player = gson.fromJson(jObjString, PopularItemModel.class);
    ...
    public void putListObject(String key, ArrayList<PopularItemModel> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (PopularItemModel player : playerList) {
