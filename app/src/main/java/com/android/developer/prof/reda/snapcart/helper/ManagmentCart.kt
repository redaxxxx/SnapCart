...
class ManagmentCart(val context: Context) {
    ...
    fun insertFood(item: PopularItemModel) {
    ...
    fun getListCart(): ArrayList<PopularItemModel> {
        return tinyDB.getListObject("CartList") ?: arrayListOf()
    }

    fun minusItem(listFood: ArrayList<PopularItemModel>, position: Int, listener: ChangeNumberItemsListener) {
    ...
    fun plusItem(listFood: ArrayList<PopularItemModel>, position: Int, listener: ChangeNumberItemsListener) {
        listFood[position].numberInCart++
        tinyDB.putListObject("CartList", listFood)
        listener.onChanged()
    }
